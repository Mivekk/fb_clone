...
const documents = {
    ...
    "query Me {\n  me {\n    ...UserFields\n  }\n}": types.MeDocument,
    "query PaginatedComments($take: Float!, $cursor: CursorObject, $where: CommentWhereInput) {\n  paginatedComments(take: $take, cursor: $cursor, where: $where) {\n    comments {\n      comment {\n        id\n        postId\n        replyId\n        body\n        author {\n          id\n          firstName\n          lastName\n          image_url\n        }\n        reactions {\n          ...ReactionFields\n        }\n        createdAt\n        updatedAt\n      }\n      hasReplies\n    }\n    hasMore\n  }\n}": types.PaginatedCommentsDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query PaginatedComments($take: Float!, $cursor: CursorObject, $where: CommentWhereInput) {\n  paginatedComments(take: $take, cursor: $cursor, where: $where) {\n    comments {\n      comment {\n        id\n        postId\n        replyId\n        body\n        author {\n          id\n          firstName\n          lastName\n          image_url\n        }\n        reactions {\n          ...ReactionFields\n        }\n        createdAt\n        updatedAt\n      }\n      hasReplies\n    }\n    hasMore\n  }\n}"): (typeof documents)["query PaginatedComments($take: Float!, $cursor: CursorObject, $where: CommentWhereInput) {\n  paginatedComments(take: $take, cursor: $cursor, where: $where) {\n    comments {\n      comment {\n        id\n        postId\n        replyId\n        body\n        author {\n          id\n          firstName\n          lastName\n          image_url\n        }\n        reactions {\n          ...ReactionFields\n        }\n        createdAt\n        updatedAt\n      }\n      hasReplies\n    }\n    hasMore\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
