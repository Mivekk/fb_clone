...
const outputsInfo = {
  ...
  FriendshipGroupBy: ["senderId", "receiverId", "status", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  FriendshipCountAggregate: ["senderId", "receiverId", "status", "_all"],
  FriendshipAvgAggregate: ["senderId", "receiverId"],
  FriendshipSumAggregate: ["senderId", "receiverId"],
  FriendshipMinAggregate: ["senderId", "receiverId", "status"],
  FriendshipMaxAggregate: ["senderId", "receiverId", "status"],
...
const inputsInfo = {
  ...
  FriendshipWhereInput: ["AND", "OR", "NOT", "senderId", "receiverId", "status", "sender", "receiver"],
  FriendshipOrderByWithRelationInput: ["senderId", "receiverId", "status", "sender", "receiver"],
  FriendshipWhereUniqueInput: ["senderId_receiverId", "AND", "OR", "NOT", "senderId", "receiverId", "status", "sender", "receiver"],
  FriendshipOrderByWithAggregationInput: ["senderId", "receiverId", "status", "_count", "_avg", "_max", "_min", "_sum"],
  FriendshipScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "senderId", "receiverId", "status"],
  ...
  FriendshipCreateInput: ["status", "sender", "receiver"],
  FriendshipUpdateInput: ["status", "sender", "receiver"],
  FriendshipCreateManyInput: ["senderId", "receiverId", "status"],
  ...
  FriendshipSenderIdReceiverIdCompoundUniqueInput: ["senderId", "receiverId"],
  FriendshipCountOrderByAggregateInput: ["senderId", "receiverId", "status"],
  FriendshipAvgOrderByAggregateInput: ["senderId", "receiverId"],
  FriendshipMaxOrderByAggregateInput: ["senderId", "receiverId", "status"],
  FriendshipMinOrderByAggregateInput: ["senderId", "receiverId", "status"],
  FriendshipSumOrderByAggregateInput: ["senderId", "receiverId"],
  ...
  FriendshipCreateNestedManyWithoutSenderInput: ["create", "connectOrCreate", "createMany", "connect"],
  FriendshipCreateNestedManyWithoutReceiverInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  FriendshipUpdateManyWithoutSenderNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  FriendshipUpdateManyWithoutReceiverNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  FriendshipCreateWithoutSenderInput: ["status", "receiver"],
  FriendshipCreateOrConnectWithoutSenderInput: ["where", "create"],
  FriendshipCreateManySenderInputEnvelope: ["data", "skipDuplicates"],
  FriendshipCreateWithoutReceiverInput: ["status", "sender"],
  FriendshipCreateOrConnectWithoutReceiverInput: ["where", "create"],
  FriendshipCreateManyReceiverInputEnvelope: ["data", "skipDuplicates"],
  ...
  FriendshipUpsertWithWhereUniqueWithoutSenderInput: ["where", "update", "create"],
  FriendshipUpdateWithWhereUniqueWithoutSenderInput: ["where", "data"],
  FriendshipUpdateManyWithWhereWithoutSenderInput: ["where", "data"],
  FriendshipScalarWhereInput: ["AND", "OR", "NOT", "senderId", "receiverId", "status"],
  FriendshipUpsertWithWhereUniqueWithoutReceiverInput: ["where", "update", "create"],
  FriendshipUpdateWithWhereUniqueWithoutReceiverInput: ["where", "data"],
  FriendshipUpdateManyWithWhereWithoutReceiverInput: ["where", "data"],
  ...
  FriendshipCreateManySenderInput: ["receiverId", "status"],
  FriendshipCreateManyReceiverInput: ["senderId", "status"],
  ...
  FriendshipUpdateWithoutSenderInput: ["status", "receiver"],
  FriendshipUpdateWithoutReceiverInput: ["status", "sender"],
