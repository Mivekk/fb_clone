...
const modelsInfo = {
  ...
  Reaction: ["id", "authorId", "type", "postId", "createdAt", "updatedAt"]
};
...
const outputsInfo = {
  ...
  ReactionGroupBy: ["id", "authorId", "type", "postId", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  ReactionCountAggregate: ["id", "authorId", "type", "postId", "createdAt", "updatedAt", "_all"],
  ReactionAvgAggregate: ["id", "authorId", "postId"],
  ReactionSumAggregate: ["id", "authorId", "postId"],
  ReactionMinAggregate: ["id", "authorId", "type", "postId", "createdAt", "updatedAt"],
  ReactionMaxAggregate: ["id", "authorId", "type", "postId", "createdAt", "updatedAt"]
};
...
const inputsInfo = {
  ...
  ReactionWhereInput: ["AND", "OR", "NOT", "id", "authorId", "type", "postId", "createdAt", "updatedAt", "author", "post"],
  ReactionOrderByWithRelationInput: ["id", "authorId", "type", "postId", "createdAt", "updatedAt", "author", "post"],
  ReactionWhereUniqueInput: ["id", "AND", "OR", "NOT", "authorId", "type", "postId", "createdAt", "updatedAt", "author", "post"],
  ReactionOrderByWithAggregationInput: ["id", "authorId", "type", "postId", "createdAt", "updatedAt", "_count", "_avg", "_max", "_min", "_sum"],
  ReactionScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "authorId", "type", "postId", "createdAt", "updatedAt"],
  ...
  ReactionCreateInput: ["type", "createdAt", "updatedAt", "author", "post"],
  ReactionUpdateInput: ["type", "createdAt", "updatedAt", "author", "post"],
  ReactionCreateManyInput: ["id", "authorId", "type", "postId", "createdAt", "updatedAt"],
  ...
  ReactionCountOrderByAggregateInput: ["id", "authorId", "type", "postId", "createdAt", "updatedAt"],
  ReactionAvgOrderByAggregateInput: ["id", "authorId", "postId"],
  ReactionMaxOrderByAggregateInput: ["id", "authorId", "type", "postId", "createdAt", "updatedAt"],
  ReactionMinOrderByAggregateInput: ["id", "authorId", "type", "postId", "createdAt", "updatedAt"],
  ReactionSumOrderByAggregateInput: ["id", "authorId", "postId"],
  ...
  ReactionCreateWithoutAuthorInput: ["type", "createdAt", "updatedAt", "post"],
  ...
  ReactionScalarWhereInput: ["AND", "OR", "NOT", "id", "authorId", "type", "postId", "createdAt", "updatedAt"],
  ...
  ReactionCreateWithoutPostInput: ["type", "createdAt", "updatedAt", "author"],
  ...
  ReactionCreateManyAuthorInput: ["id", "type", "postId", "createdAt", "updatedAt"],
  ...
  ReactionUpdateWithoutAuthorInput: ["type", "createdAt", "updatedAt", "post"],
  CommentCreateManyPostInput: ["id", "authorId", "body", "createdAt", "updatedAt"],
  ReactionCreateManyPostInput: ["id", "authorId", "type", "createdAt", "updatedAt"],
  CommentUpdateWithoutPostInput: ["body", "createdAt", "updatedAt", "author"],
  ReactionUpdateWithoutPostInput: ["type", "createdAt", "updatedAt", "author"]
};
